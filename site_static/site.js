...
const TRANSLATIONS = {
    en: {
        ...
        hero_badge: "Base version live / $3 one-time / Pro v2.0 in development",
        hero_title: "Codevanta Base is live now. Pro v2.0 is already in development.",
        hero_lead: "The current base release is a lightweight crypto AI decision-support program: market scan, weak-setup filtering, setup scoring, and a local workspace flow.",
        hero_primary_text: "Buy Base Version - $3",
        ...
        plans_heading: "Base version is available now. Pro v2.0 is still in development.",
        faq_heading: "Questions traders usually ask before they commit",
        cta_heading: "Buy the current base version for $3 and track the Pro v2.0 roadmap separately.",
        cta_primary_text: "Buy Base Version",
    ...
    uk: {
        ...
        hero_badge: "Базова версія вже є / $3 разово / Pro v2.0 у розробці",
        hero_title: "Базова версія Codevanta вже доступна. Pro v2.0 ще розробляється.",
        hero_lead: "Поточний base release — це легка crypto AI програма для підтримки рішень: скан ринку, фільтрація слабких сетапів, оцінка входів і локальний workflow.",
        hero_primary_text: "Купити базову версію - $3",
        ...
        plans_heading: "Базова версія вже доступна. Pro v2.0 ще в розробці.",
        faq_heading: "Питання, які трейдери ставлять перед стартом",
        cta_heading: "Купуй поточну базову версію за $3, а Pro v2.0 розглядай як окрему roadmap-версію.",
        cta_primary_text: "Купити базову версію",
    ...
    ru: {
        ...
        hero_badge: "Базовая версия уже есть / $3 разово / Pro v2.0 в разработке",
        hero_title: "Базовая версия Codevanta уже доступна. Pro v2.0 ещё разрабатывается.",
        hero_lead: "Текущий base release — это лёгкая crypto AI программа для поддержки решений: скан рынка, фильтрация слабых сетапов, оценка входов и локальный workflow.",
        hero_primary_text: "Купить базовую версию - $3",
        ...
        plans_heading: "Базовая версия уже доступна. Pro v2.0 ещё в разработке.",
        cta_heading: "Покупай текущую базовую версию за $3, а Pro v2.0 рассматривай как отдельную roadmap-версию.",
        cta_primary_text: "Купить базовую версию",
